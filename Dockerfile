FROM cgr.dev/chainguard/node:latest-dev@sha256:65aeed403d9f11029465f580bdc69c553fab13bdd56d42a160ff0cb12babe5f7
...
MISE_VERSION=2026.4.28 MISE_INSTALL_PATH=/usr/local/bin/mise sh /tmp/mise-install.sh
...
# Install pi globally
RUN npm install -g "@mariozechner/pi-coding-agent@0.72.1"
